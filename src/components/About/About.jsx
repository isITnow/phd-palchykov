  ...
  return (
    <>
      ...
      <ul>
        <li>
          <p className="mb-2">
            <strong>2019</strong> - present Director of the Research Institute
            of Chemistry and Geology, DNU
          </p>
        </li>
        <li>
          <p className="mb-2">
            <strong>2021</strong> - present Full Professor (<em>part time</em>),
        ...
        <li>
          <p className="mb-2">
            <strong>2008 - 2011</strong> Assistant Professor (<em>part time</em>
            ), Department of Organic Chemistry, DNU
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p className="mb-2">
            <strong>2022</strong> - present Affiliate member of the Royal
            Society of Chemistry, UK
          </p>
        </li>
        <li>
          <p className="mb-2">
            <strong>2013</strong> - present Member of Oxford University
            Ukrainian Society{" "}
          </p>
        </li>
        <li>
